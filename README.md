...
<!-- スクリーンショットを3枚ここに置く。路線図 / リール / ゲーム の順が分かりやすい -->

| | |
|---|---|
| 開発期間 | ◯週間 |
| 開発人数 | 1人（設計・実装・デプロイすべて） |
| 技術 | React (Vite) / Supabase (PostgreSQL・Auth) / Vercel |

## できること

- **路線図タブ** … 4路線（中央線 / 山手線 / 田園都市線・半蔵門線 / 東横線）を切り替えて駅を選び、その駅のラーメン記録を見る・投稿する
- **リールタブ** … 路線に関係なく新着50件を流し見する
- **ゲームタブ** … 「記録が多いのはどっち？」の2択クイズ。既存の集計データを流用している
